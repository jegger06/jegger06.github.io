...
toolbox.router.get(/fonts.googleapis.com/, toolbox.fastest, {"cache":{"maxEntries":15,"name":"runtime-cache(cdn)"}});
toolbox.router.get(/fonts.gstatic.com/, toolbox.fastest, {"cache":{"maxEntries":15,"name":"runtime-cache(cdn)"}});
toolbox.router.get(/cdn.ampproject.org/, toolbox.fastest, {"cache":{"maxEntries":15,"name":"runtime-cache(cdn)"}});
